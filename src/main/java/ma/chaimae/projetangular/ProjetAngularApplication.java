package ma.chaimae.projetangular;

import ma.chaimae.projetangular.dtos.BankAccountDTO;
import ma.chaimae.projetangular.dtos.CurrentBankAccountDTO;
import ma.chaimae.projetangular.dtos.CustomerDTO;
import ma.chaimae.projetangular.dtos.SavingBankAccountDTO;
import ma.chaimae.projetangular.entities.*;
...
import ma.chaimae.projetangular.repositories.AccountOperationRepository;
import ma.chaimae.projetangular.repositories.BankAccountRepository;
import ma.chaimae.projetangular.repositories.CustomerRepository;
import ma.chaimae.projetangular.services.BankAccountService;
import ma.chaimae.projetangular.services.BankService;
...
public class ProjetAngularApplication {
    ...
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService){
        return args -> {
            Stream.of("Chorouk","Souad","Diyae").forEach(name->{
    ...
    CommandLineRunner start(CustomerRepository customerRepository,
        ...
        return args -> {
            Stream.of("Aya","Doha","Wiam").forEach(name->{
